...
function getProducts() {
    ...
    if (saved) {
        ...
        // Productos iniciales según tienda
        const initialProducts = storeType === 'hogar' ? [
            ...
            },
            {
                ...
                category: "pantalones",
                price: 35.50,
                image: "image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==",
                sold: false,
                discount: 0,
...
function getWhatsappNumber() {
    return localStorage.getItem(STORAGE_KEY_WHATSAPP) || '+59892680402';
}
...
// Finalizar compra — ¡CORREGIDO PARA INPUTS!
function checkout() {
    if (cart.length === 0) {
    ...
    // 👇 CIERRA EL MODAL DEL CARRITO ANTES DE ABRIR SWEETALERT
...
${installments ? '*PAGO EN CUOTAS*' : '*PAGO CONTADO*'}
...
¡Gracias!
                ...
                // Si cancela, volver a abrir el carrito
                setTimeout(() => {
    ...
    }, 300); // Pequeño retraso para asegurar que el modal se cierre
}
